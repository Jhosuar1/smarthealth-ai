...
function estadoClass(e) {
  return { pendiente:'bg-orange', preparando:'bg-teal', en_camino:'bg-blue', entregado:'bg-green', cancelado:'bg-gray', cancelada:'bg-gray', activa:'bg-green', completada:'bg-teal' }[e] || 'bg-gray';
}
